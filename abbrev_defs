...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("arguemnt" "argument" nil 1)
    ("argumetn" "argument" nil 3)
    ("arnt" "aren't" nil 0)
    ("arond" "around" nil 0)
    ...
    ("conditinoally" "conditionally" nil 1)
    ...
    ("funcitons" "functions" nil 2)
    ("functino" "function" nil 14)
...
(define-abbrev-table 'snakemake-mode-abbrev-table '())
